...
namespace Shine.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddEmailVerification : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Accounts created before email verification was introduced remain active.
            migrationBuilder.Sql("""
                UPDATE "Users"
                SET "EmailVerifiedAtUtc" = "CreatedAtUtc"
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailVerificationTokens_UserId_UsedAtUtc",
                table: "EmailVerificationTokens",
