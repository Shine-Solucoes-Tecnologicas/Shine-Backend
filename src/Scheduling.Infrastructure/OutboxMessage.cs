...
public sealed class OutboxMessage
{
    ...
    public OutboxMessage(string eventType, string payload, DateTime occurredAtUtc) { Id = Guid.NewGuid(); EventType = eventType; Payload = payload; OccurredAtUtc = occurredAtUtc; }
